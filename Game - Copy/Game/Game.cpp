...
int main()
{
    ...
    while (window.isOpen()) {
        ...
        glVertexPointer(3, GL_FLOAT, 5 * sizeof(GLfloat), cube1);
        glTexCoordPointer(2, GL_FLOAT, 5 * sizeof(GLfloat), cube1 + 3);
        glDrawArrays(GL_TRIANGLES, 0, 30);
        
        sf::Texture::bind(&texture2);
        glVertexPointer(3, GL_FLOAT, 5 * sizeof(GLfloat), cube2);
        glTexCoordPointer(2, GL_FLOAT, 5 * sizeof(GLfloat), cube2 + 3);
